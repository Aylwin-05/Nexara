...
class VerifyOTPRequest(BaseModel):
    ...
    # Required ONLY when the email has no account yet: the OTP handler
    # creates the account, and a new account cannot exist without
    # acceptance. Ignored for existing accounts (they never re-consent).
