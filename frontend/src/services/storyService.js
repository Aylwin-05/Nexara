...
const storyService = {
    ...
    async getMedia(story, myUserId) {
        ...
        if (
            ...
            // No wrapped key for this viewer (e.g. their public
            // key was not published when the story was posted).
            // The blob is ciphertext; never render it raw.
            throw new Error(
                "No key available to decrypt this story."
            );
